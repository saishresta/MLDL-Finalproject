...
class convNet(nn.Module):
    def __init__(self, batch_size, num_spkr):
        ...
        # self.fc4_dp = nn.Dropout(p=self.fc_dp_prob)
    ...
    def EEG_model_init(self):
        ...
        # self.E_conv5 = nn.Conv2d(self.num_conv_kernels_1, self.num_conv_kernels_1, kernel_size=(7,1), padding=(3,0))
        # self.E_conv5_bn = nn.BatchNorm2d(self.num_conv_kernels_1)
        # self.E_conv5_dp = nn.Dropout(p=self.E_dp_prob) 
    ...
    def Audio_model_init(self):
        ...
        # self.A_conv6 = nn.Conv2d(self.num_conv_kernels_1, self.num_conv_kernels_4, kernel_size=(1,1))
        # self.A_mPool6 = nn.MaxPool2d((2,2))
        # self.A_conv6_bn = nn.BatchNorm2d(self.num_conv_kernels_4)  
        # self.A_conv6_dp = nn.Dropout(p=self.aud_dp_prob) # ReLU before
        # self.A_conv6 = nn.Conv2d(self.num_conv_kernels_1, self.num_conv_kernels_1, kernel_size=(3,3), padding=(0,16), dilation=(16,16))
        # self.A_conv6_bn = nn.BatchNorm2d(self.num_conv_kernels_1)  
        # self.A_conv6_dp = nn.Dropout(p=self.aud_dp_prob) # ReLU before
    ...
    def EEG_model_convs(self, x):
        ...
        # x = self.E_conv5_bn(self.E_conv5(x))
        # x = self.E_conv5_dp(F.relu(x)) 
